...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        translationAdapter = new TranslationAdapter(translationList);
...
translationRecyclerView.setLayoutManager(translationLayoutManager);
        ...
        translateButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                sendRequest(input.getText().toString(), source.getSelectedItemPosition(), target.getSelectedItemPosition());
    ...
    private void sendRequest(final String text, final int sourceIndex, final int targetIndex) {
    ...
    private void populateList(String response) {
        try {
            ...
            for (int i = 0; i < TranslationArray.length(); i++) {
                ...
                String TranslatedText = name + " : " + translation + " L : "+likes + " D : "+ dislikes;

                translationList.add(new Translation(TranslatedText));
            }
